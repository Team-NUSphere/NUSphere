...
export default function DayClass({
  ...
  return (
    <div
      className="absolute left-1 right-1 rounded-md px-2 py-1 text-ellipsis bg-orange-300 shadow-sm hover:bg-orange-500 cursor-pointer transition-colors duration-400 ease-out select-none hover:z-1000"
      style={style}
    >
