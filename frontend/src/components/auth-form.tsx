...
import { CatDecorations } from "./cat-decorations"
import "../output.css"
                ...
                <div className="relative z-10 bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
                    ...
                    <div className="text-center space-y-2 pt-8 pb-6 px-8">
                        ...
                        <p className="text-gray-600 text-sm">
                            {isLogin ? "To continue, please enter your details." : "Join us today! Please fill in your information."}
                        </p>
                    </div>
                    ...
                    <div className="px-8 pb-8 space-y-6">
                        ...
                        <div className="text-xs text-center text-gray-500 leading-relaxed">
                            ...
                            <button className="text-orange-600 hover:text-orange-700 transition-colors">Terms of Service</button> and{" "}
                            <button className="text-orange-600 hover:text-orange-700 transition-colors">Privacy Policy</button>, confirm
                            that I am 18 years of age or older, and consent to receiving email communication.
                        </div>
                    </div>
                </div>
            </div>
